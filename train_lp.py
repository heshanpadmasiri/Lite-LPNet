...
import os
import datetime
from dataset.lp_dataset import get_datasets
from models.lp_dispatcher import create_model
...
def __get_paths__(model_name,idx):
    log_dir = f"logs/lp_seperate/{model_name}/{idx}/" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
    checkpoint_dir = f"checkpoints/{model_name}"
    return log_dir, checkpoint_dir

def __get_callbacks__(model_name,idx):
    log_dir, checkpoint_dir = __get_paths__(model_name,idx)
